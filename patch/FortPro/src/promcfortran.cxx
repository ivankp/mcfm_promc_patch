...
void PromcFortran::Initialise(int myid, char* filename, char* message, int maxIter, int nrCalls, double Energy)
{
	...
	//char *filename;
        //sprintf(filename,"Pythia6.promc.%d",myid);

        //string workdir1=string(workdir);
        //string filename1=string(filename);
        //std::ostringstream sin;
        //sin << myid;
        //std::string val = sin.str();

        //filename1 = workdir1+"/"+filename1+"_"+val+".promc";
        //sprintf(filename,"/gpfs/vesta-fs0/projects/ASC-HEP-ANL/pythia6_output/Pythia6.promc.%d",myid);
        cout << "In PromcFortran::Initialise Opening output filename = " << filename << endl;
...
void PromcFortran::AddParticle(int barcode, double px, double py, double pz, double e)
{
