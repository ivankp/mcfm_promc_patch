...
/////////////////////////////////////////////////////////////////////////
                ...
                // we will look at Nr of entries
                 ...
                 addtype=1;
                 if (zip_nentries>65000) addtype=0;
                 zip_close(zipfile);
                 //cout << "ProMCBook: " << zip_nentries << "entries.." << endl;
                 if (addtype==0)  cout << "ProMCBook: I/O mode -> zip64 detected (>65k event support)" << endl;
	...
	if (isToWrite==true) {
		...
		if(!ifs1.fail()) {
			...
			cout << " Info: File=" << filename << " not found. No logfile info is written" << endl;
             ...
             if (addtype==1) {  outzip->close();  cout << " ##### ProMC file is closed. #####" << endl;  }
        ...
        if ( isToWrite==false) {
          ...
          if (addtype==1) {zfile->close(); inpzip->close(); };
