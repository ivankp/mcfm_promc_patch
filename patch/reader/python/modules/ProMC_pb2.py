...
_PROMCEVENT_EVENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='Weight', full_name='promc.ProMCEvent.Event.Weight', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='Info', full_name='promc.ProMCEvent.Event.Info', index=3,
...
_PROMCEVENT_PARTICLES = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\020\001')),
    _descriptor.FieldDescriptor(
      name='Px', full_name='promc.ProMCEvent.Particles.Px', index=2,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\020\001')),
    _descriptor.FieldDescriptor(
      name='Py', full_name='promc.ProMCEvent.Particles.Py', index=3,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\020\001')),
    _descriptor.FieldDescriptor(
      name='Pz', full_name='promc.ProMCEvent.Particles.Pz', index=4,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\020\001')),
    _descriptor.FieldDescriptor(
      name='Energy', full_name='promc.ProMCEvent.Particles.Energy', index=5,
